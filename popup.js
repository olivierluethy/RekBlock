...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Hinzufügen oder Bearbeiten einer blockierten URL handhaben
  document.getElementById('addButton').addEventListener('click', function() {
    ...
    if (!domain) {
      alert('Ungültige Domain. Bitte geben Sie eine gültige Domain mit TLD ein (z. B. schindler.ch, example.com).');
      return;
    }
